@echo off
title COSMOS Frontend - Dev Server
...
if not exist package.json (
    ...
    echo The batch file must stay inside the Frontend folder of the COSMOS project.
    pause
    exit /b 1
)
...
echo Starting COSMOS frontend with: npm run dev
